            ...
            <form onSubmit={handleSubmit} className='create-form'>
              ...
              <div className='form-container container'>
                ...
                <div className='create-name'>
                  ...
                  <input onChange={fullNameValidation} required className={fullNameErr ? 'error' : ''} ref={nameEl} id='create_name' />
                </div>
                <div className='create-phone'>
                  <label htmlFor='create_phone'>SĐT: </label>
                  <input onChange={phoneNumberValidate} className={phoneNumberErr ? 'error' : ''} required ref={phoneEl} id='create_phone' />
                </div>
                <div className='create-mail'>
                  <label htmlFor='create_mail'>email: </label>
                  <input onChange={(e) => emailValidation(e)} className={emailErr ? 'error' : ''} required ref={mailEl} id='create_mail' />
                </div>
                ...
                <div className='create-username'>
                  ...
                  <input onChange={(e) => usernameValidation(e)} className={usernameErr ? 'validate-error' : ''} required ref={usernameEl} id='create_username' />
                </div>
                <div className='create-password'>
                  <label htmlFor='create_password'>Mật khẩu: </label>
                  <input onChange={passValidation} className={passErr ? 'error' : ''} required ref={passwordEl} id='create_password' />
                </div>
